...
This is the readme for The Doom of Doom, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. TheDoomOfDoom) > Ok.
...
- To run the project find TheDoomOfDoom.java (which will be in under src/main/java/thedoomofdoom) and right click > Run 'TheDoomOfDoom'
